...
export default function ParkingLotsWithDates(props) {
    ...
    const retrieveAllParkingLotsAreaData = () =>{
        ParkingLotsWithDatesService.getAll().then(response => {
    ...
    const getPkLotList = ({item}) => {
        ...
        if(item === searchParkingLot) {
            ParkingLotsWithDatesService.getParkingData(item).then(response => {
    ...
    const findParkingLotByLocation = () =>{
        ...
        ParkingLotsWithDatesService.getParkingData(searchLocation).then(response => {
            setParkLot(response.data);
            console.log(response);
